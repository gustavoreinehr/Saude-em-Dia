...
uses
  ...
  Vcl.Imaging.pngimage, Tela_Cadastro, Castro_Meicamento,Tela_Lembrete;
...
begin
  Self.Hide;
  try
    Cadastro_Medicamento := TCadastro_Medicamento.Create(nil);
    try
      Cadastro_Medicamento.ShowModal;
    finally
      FreeAndNil(Cadastro_Medicamento);
      Self.show
    end;
  finally
  end;
